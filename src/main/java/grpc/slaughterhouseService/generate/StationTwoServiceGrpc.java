...
public final class StationTwoServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.slaughterhouseService.StationTwoService";
  ...
  private static final class StationTwoServiceMethodDescriptorSupplier
    ...
    StationTwoServiceMethodDescriptorSupplier(String methodName) {
