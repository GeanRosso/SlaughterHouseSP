...
public final class StationOneServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.slaughterhouseService.StationOneService";
  ...
  private static final class StationOneServiceMethodDescriptorSupplier
    ...
    StationOneServiceMethodDescriptorSupplier(String methodName) {
